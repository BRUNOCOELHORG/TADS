...
Regras
Todas as entradas devem ser informadas pelo usuário em tempo de execução utilizando Scanner.
Não utilize laços de repetição (for, while, do...while).
Não utilize vetores, matrizes, métodos criados pelo aluno, switch, operador ternário ou outros recursos ainda não estudados.
Quando houver comparação de textos (String), utilize .equals(...).
A partir do exercício 11, os problemas exigem múltiplas decisões, podendo envolver if independentes, cadeias if / else if / else e/ou condicionais aninhadas.
Procure organizar a solução em pequenos passos: leitura dos dados, cálculos necessários, testes condicionais e apresentação do resultado.
...
Se a entrada for pelo menos 30% do valor do bem, informe "Boa entrada"; caso contrário, informe "Entrada baixa".
...
Se a nota for 10, os 10 exercícios tiverem sido entregues e a presença for pelo menos 90%, mostre também "Desempenho de destaque".
...
para clientes com menos de 21 anos, mesmo com condição financeira adequada, o resultado deve ser "Análise adicional necessária";
...
O valor dos produtos deve ser positivo e a distância não pode ser negativa.
Clientes PREMIUM recebem inicialmente 5% de desconto.
Depois, analise o cupom:
...
O desconto do cupom deve ser calculado sobre o valor original dos produtos.
Os descontos de cliente premium e cupom podem ser acumulados.
Após os descontos, calcule o frete:
até 5 km: R$ 10;
acima de 5 km até 15 km: R$ 20;
acima de 15 km: R$ 35.
O frete será grátis se:
...
frete;
valor final.
Para cupom ou tipo de cliente inválido, apresente uma mensagem de erro e não realize o cálculo final.
Observação final
